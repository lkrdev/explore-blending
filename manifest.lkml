...
application: explore_blending {
  ...
  entitlements: {
    ...
    use_embeds: yes
    use_clipboard: yes
    core_api_methods: ["me", "all_lookml_models", "query", "lookml_model_explore", "run_query", "create_sql_query", "run_sql_query", "search_dashboards", "create_dashboard_element", "connection", "search_dashboards", "dashboard", "all_connections","update_artifacts"]
