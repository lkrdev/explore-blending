# Looker Extension lkr-extension-explore-blending

lkr-extension-explore-blending is a Looker extension using React and TypeScript.
...
5. Create a `manifest` file
   ...
   ```
    project_name: "lkr-extension-explore-blending"
    application: lkr-extension-explore-blending {
        label: "lkr-extension-explore-blending React/TypeScript extension"
